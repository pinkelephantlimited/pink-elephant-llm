...
# jupyter:
#   marimo:
#     name: "Train 77M General LLM on molab"
# ---

# %% [markdown]
# # Train 77M General-Purpose LLM on molab
#
# **GPU**: NVIDIA RTX Pro 6000 Blackwell (96GB VRAM) — free on molab
# **Architecture**: LLaMA ~77M params (hidden=768, layers=9, heads=12)
...
# %% [markdown]
# ## 5. Create Model (77.6M params)
#
# Architecture: hidden=768, intermediate=2112, layers=9, heads=12
# VRAM: ~155MB (weights) + ~155MB (8bit Adam) + ~155MB (grads) + ~50MB (acts) ≈ 515MB
