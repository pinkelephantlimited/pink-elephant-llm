...
# jupyter:
#   marimo:
#     name: "Train 66M General LLM on molab"
# ---

# %% [markdown]
# # Train 66M General-Purpose LLM on molab
#
# **GPU**: NVIDIA RTX Pro 6000 Blackwell (96GB VRAM) — free on molab
# **Architecture**: LLaMA ~66M params (hidden=768, layers=7, heads=12)
...
# %% [markdown]
# ## 5. Create Model (66.3M params)
#
# Architecture: hidden=768, intermediate=2304, layers=7, heads=12
# VRAM: ~133MB (weights) + ~133MB (8bit Adam) + ~133MB (grads) + ~50MB (acts) ≈ 449MB
