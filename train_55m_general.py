...
# jupyter:
#   marimo:
#     name: "Train 55M General LLM on molab"
# ---

# %% [markdown]
# # Train 55M General-Purpose LLM on molab
#
# **GPU**: NVIDIA RTX Pro 6000 Blackwell (96GB VRAM) — free on molab
# **Architecture**: LLaMA ~55M params (hidden=640, layers=8, heads=10)
...
# %% [markdown]
# ## 5. Create Model (55.1M params)
#
# Architecture: hidden=640, intermediate=2048, layers=8, heads=10
# VRAM: ~110MB (weights) + ~110MB (8bit Adam) + ~110MB (grads) + ~50MB (acts) ≈ 380MB
